...
<div id="caja"> 
	   ...
	   <p>Todos los derechos resevados.</p></b>
		...
		<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<p style="color: #3097FF; font-weight: bold; font-size: 30px;">TIPO DE TELÉFONO - INGRESAR UN REGISTRO</p>
 <?
echo'<FORM METHOD="POST" ACTION="tel.php">';
echo'<p style="font-weight: bold; font-size: 15px">CLAVE: &nbsp; &nbsp; <INPUT TYPE="TEXT" NAME="id"></p>';
echo'<p style="font-weight: bold; font-size: 15px">TIPO: &nbsp; &nbsp; <INPUT TYPE="TEXT" NAME="nom"></p>';
...
{
	mysql_query("INSERT INTO TELEFONO (CLAVE_TEL,TIPO_TEL) VALUES ('$id','$nom')");
