...
<p style="color: #3097FF; font-weight: bold; font-size: 30px;">TELÉFONO DE AYUDANTE - INGRESAR UN REGISTRO</p>
 <?
echo'<FORM METHOD="POST" ACTION="telayu.php">';
...
{
	mysql_query("INSERT INTO TELAYU (CA4,CT1,NUM) VALUES ('$id','$tipo','$num')");
