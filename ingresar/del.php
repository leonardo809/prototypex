...
<div id="caja"> 
	   ...
	   <p>Todos los derechos resevados.</p></b>
		...
		<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<p style="color: #3097FF; font-weight: bold; font-size: 30px;">DELEGACIÓN - INGRESAR UN REGISTRO</p>
 <?
echo'<FORM METHOD="POST" ACTION="del.php">';
echo'<p style="font-weight: bold; font-size: 15px">CLAVE: &nbsp; &nbsp; <INPUT TYPE="TEXT" NAME="id"></p>';
echo'<p style="font-weight: bold; font-size: 15px">DELEGACIÓN: &nbsp; &nbsp; <INPUT TYPE="TEXT" NAME="nom"></p>';
...
{
	mysql_query("INSERT INTO DELEGACION (CLAVE_DEL,NOM_DEL) VALUES ('$id','$nom')");
