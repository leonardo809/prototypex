...
<div id="caja"> 
	   ...
	   <p>Todos los derechos resevados.</p></b>
		...
		<p style="color: #3097FF; font-weight: bold; font-size: 30px;">TELÉFONO DE EMPRESA - ELIMINAR</p>
...
echo "<td><a href=".$_SERVER['PHP_SELF']."?borrar=".$row['NUM2']."><img src='/Prototypex/images/opciones/delete.png' height=26></a></td>";
}
echo'</table>
<br>
</div>
...
/* AYUDANTE.CLAVE_AYU=TELAYU.CA4 */
	...
	if (isset ($borrar)){
		$sql="DELETE FROM TELEMP WHERE NUM2=".$borrar;
		if(@mysql_query($sql)){
