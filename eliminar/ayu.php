...
<div id="caja"> 
	   ...
	   <p>Todos los derechos resevados.</p></b>
		...
		<p style="color: #3097FF; font-weight: bold; font-size: 30px;">AYUDANTE - ELIMINAR</p>
...
echo "<td><a href=".$_SERVER['PHP_SELF']."?borrar=".$row['CLAVE_AYU']."><img src='/Prototypex/images/opciones/delete.png' height=26></a></td>";
}
echo'</table>
<br>
</div>
	...
	if (isset ($borrar)){
		$sql="DELETE FROM AYUDANTE WHERE CLAVE_AYU=".$borrar;
		if(@mysql_query($sql)){
