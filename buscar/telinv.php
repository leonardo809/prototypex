...
<div id="caja"> 
	   ...
	   <p>Todos los derechos resevados.</p></b>
		...
		<p style="color: #3097FF; font-weight: bold; font-size: 30px;">TELÉFONO DE INVENTOR - BÚSQUEDA</p>
		<form action="telinv.php" method="post" name="telinv">CLAVE: &nbsp; &nbsp; <input type="text" align="LEFT" name="clave" value="<?php echo $registro['CI4'];?>"/> &nbsp; &nbsp; <input type="submit" value="Buscar" name="Buscar"></form><br>
...
FROM TELINV
INNER JOIN INVENTOR ON INVENTOR.CLAVE_INV=TELINV.CI4
INNER JOIN TELEFONO ON TELEFONO.CLAVE_TEL=TELINV.CT1 where CI4=".$clave;
	$resultado1= @ mysql_query ($sql);
	if (!$resultado1)
	{
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<a href="telinv.php" style="color: #ffffff;"/>Regresar</a></li></p>
</div>
<div id="main-header" align=center><img src="/Prototypex/images/blanco/logo.png"></div>
	   <div id="derecho" align=center>
	   <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
...
<div id="central" align="center">
  ...
  <p align="center" style="color: #3097FF; font-weight: bold; font-size: 30px;">TELÉFONO DE INVENTOR</p>
  <table align="center" border="1">
  <tr><td align=center>CLAVE DE INVENTOR</td>
