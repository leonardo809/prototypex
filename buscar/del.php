...
<div id="caja"> 
	   ...
	   <p>Todos los derechos resevados.</p></b>
		...
		<p style="color: #3097FF; font-weight: bold; font-size: 30px;">DELEGACIÓN - BÚSQUEDA</p>
		<form action="del.php" method="post" name="delegacion">CLAVE: &nbsp; &nbsp; <input type="text" align="LEFT" name="clave" value="<?php echo $registro['CLAVE_DEL'];?>"/> &nbsp; &nbsp; <input type="submit" value="Buscar" name="Buscar"></form>
...
<body>
 	<?php
 	$sql =  "Select * from DELEGACION where CLAVE_DEL=".$clave;
	$resultado1= @ mysql_query ($sql);
	if (!$resultado1)
	{
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<a href="del.php" style="color: #ffffff;"/>Regresar</a></li></p>
</div>
<div id="main-header" align=center><img src="/Prototypex/images/blanco/logo.png"></div>
	   <div id="derecho" align=center>
	   <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
...
<div id="central" align="center">
  ...
  <p align="center" style="color: #3097FF; font-weight: bold; font-size: 30px;">DELEGACIÓN</p>
