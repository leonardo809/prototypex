...
<div id="caja"> 
	   ...
	   <p>Todos los derechos resevados.</p></b>
		...
		<p style="color: #3097FF; font-weight: bold; font-size: 30px;">TELÉFONO DE AYUDANTE - ACTUALIZAR</p>
    <table align="center" border="1">
    <tr>
    <td align=center>AYUDANTE</td>
...
{
echo "<tr><td align=center>". $row["CA4"]. "</td>";
...
open(url,'','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=750,height=500,left=600,top=100')
	...
	<link rel="stylesheet" type="text/css" href="protostyle.css">
	<title>Teléfono de Ayudante - Prototypex</title>
	<style type="text/css">
	html, body {
		width: 100%;
		height: 100%;
	...
	<div id="caja"> 
	        <div id="izquierdo" align=center>
		    <br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		    <p><li><a href="telayu.php" style="color: #ffffff;"/>Regresar</a></li></p>
		    </div>    
		    <div id="main-header" align=center><img src="/Prototypex/images/blanco/logo.png"></div>
		    <div id="derecho" align=center>
	        ...
	        <div id="central" align="center">
					<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		<p style="color: #ffffff;"/><a href="javascript:window.abrir('/Prototypex/popup/ayu.php')"><img src="/Prototypex/images/azul/conayudanteb.png"></a>___<a href="javascript:window.abrir('/Prototypex/popup/tel.php')"><img src="/Prototypex/images/azul/contelb.png"></a>
			<p style="color: #3097FF; font-weight: bold; font-size: 30px;">TELÉFONO DE AYUDANTE - EDITANDO DATOS</p>
			<p><form action="<?php echo $_SERVER['PHP_self'];?>" method="post" name="telinv"></p>
<?
echo'<p style="font-weight: bold; font-size: 15px">AYUDANTE: &nbsp; &nbsp;'; 
$con="SELECT CLAVE_AYU FROM AYUDANTE";
$res=@mysql_query($con);
if(!$res){
echo " fallo";
}
...
echo "<option>", $fila['CLAVE_AYU']," </option>";
}
echo "</select>";
}
$id=$_POST['combo1'];
