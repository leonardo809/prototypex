...
$sql =  "SELECT * FROM AYUDANTE ORDER BY CLAVE_AYU ASC";
...
<div id="caja"> 
	   ...
	   <p>Todos los derechos resevados.</p></b>
		...
		<p style="color: #3097FF; font-weight: bold; font-size: 30px;">AYUDANTE - ACTUALIZAR</p>
...
echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['CLAVE_AYU']."><img src='/Prototypex/images/opciones/edit.png' height=32></a></td></tr>";
}
echo'</FORM>
</table>
<br>
...
if (isset ($cambiar)){
	$db="patentes";
	$tabla="ayudante";
	$sql = "SELECT * FROM ".$tabla." WHERE CLAVE_AYU=".$cambiar;
...
open(url,'','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=750,height=500,left=600,top=100')
	...
	<div id="caja"> 
	        <div id="izquierdo" align=center>
		    <br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		    <p><li><a href="ayu.php" style="color: #ffffff;"/>Regresar</a></li></p>
		    </div>    
		    <div id="main-header" align=center><img src="/Prototypex/images/blanco/logo.png"></div>
		    <div id="derecho" align=center>
		...
		<p style="color: #ffffff;"/><a href="javascript:window.abrir('/Prototypex/popup/cal.php')"><img src="/Prototypex/images/azul/concalleb.png"></a>___<a href="javascript:window.abrir('/Prototypex/popup/col.php')"><img src="/Prototypex/images/azul/concoloniab.png"></a></a>___<a href="javascript:window.abrir('/Prototypex/popup/del.php')"><img src="/Prototypex/images/azul/condelegacionb.png"></a>___<a href="javascript:window.abrir('/Prototypex/popup/emp.php')"><img src="/Prototypex/images/azul/conempresab.png"></a>___<a href="javascript:window.abrir('/Prototypex/popup/inv.php')"><img src="/Prototypex/images/azul/coninventorb.png"></a></p>
			<p style="color: #3097FF; font-weight: bold; font-size: 30px;">AYUDANTE - EDITANDO DATOS</p>
			<form action="<?php echo $_SERVER['PHP_self'];?>" method="post" name="ayudante">
			<p> <input type="hidden" align="LEFT" name="id" value="<?php echo $registro['CLAVE_AYU'];?>" /><p>
			<p style="font-weight: bold; font-size: 15px">NOMBRE: &nbsp; &nbsp;<input type="text" align="LEFT" name="nombre" value="<?php echo $registro['NOM_AYU'];?>"/><p>
			<p style="font-weight: bold; font-size: 15px">RFC: &nbsp; &nbsp;<input type="text" align="LEFT" name="rfc" value="<?php echo $registro['RFC'];?>"/><p>
			<p style="font-weight: bold; font-size: 15px">FECHA DE INGRESO: &nbsp; &nbsp;<input type="text" align="LEFT" name="fecha" value="<?php echo $registro['FECHA_AYU'];?>"/><p>
<?
