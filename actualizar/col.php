...
<div id="caja"> 
	   ...
	   <p>Todos los derechos resevados.</p></b>
		...
		<p style="color: #3097FF; font-weight: bold; font-size: 30px;">COLONIA - ACTUALIZAR</p>
...
echo "<td><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['CLAVE_COL']."><img src='/Prototypex/images/opciones/edit.png' height=32></a></td></tr>";
}
echo'</FORM>
</table>
<br>
...
if (isset ($cambiar)){
	$db="patentes";
	$tabla="colonia";
	$sql = "SELECT * FROM ".$tabla." WHERE CLAVE_COL=".$cambiar;
	...
	<div id="caja"> 
	        <div id="izquierdo" align=center>
		    <br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		    <p><li><a href="col.php" style="color: #ffffff;"/>Regresar</a></li></p>
		    </div>    
		    <div id="main-header" align=center><img src="/Prototypex/images/blanco/logo.png"></div>
		    <div id="derecho" align=center>
	        ...
	        <div id="central" align="center">
			<br><br><br><br><br><br><br><br><br><br><br><br><br>
			<p style="color: #3097FF; font-weight: bold; font-size: 30px;">COLONIA - EDITANDO DATOS</p>
			<form action="<?php echo $_SERVER['PHP_self'];?>" method="post" name="colonia">
			<p> <input type="hidden" align="LEFT" name="id" value="<?php echo $registro['CLAVE_COL'];?>" /><p>
			<p style="font-weight: bold; font-size: 15px">COLONIA: &nbsp; &nbsp;<input type="text" align="LEFT" name="nombre" value="<?php echo $registro['NOM_COL'];?>"/><p>
